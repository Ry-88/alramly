...
<div class="container" style="margin-top:20px">
    ...
    <div class="row">
        <div class="col-6">
            <h3 style="margin-bottom: 5rem;">أضافة فعالية </h3>
        </div>
        <div class="col-6">
            <a href="{{ route('events.index') }}" class="btn btn-outline-success waves-effect">رجوع</a>
        </div>
    </div>
       <form class="form form-vertical" action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
           @csrf
           <div class="row">
               <div class="col-8">
                   <div class="form-group">
                       <label for="first-name-vertical">عنوان الفعالية بالعربي</label>
               ...
               <div class="col-8">
                <div class="form-group">
                    ...
                    <input type="text" id="first-name-vertical" class="form-control" name="title_en">
                    @error('title_en') 
                    <span id="basic-default-name-error" class="error">
                        {{ $message }}
                    </span>
            ...
            <div class="col-8">
                <div class="form-group">
                    ...
                    <input type="time" id="first-name-vertical" class="form-control" name="time">
                    @error('time') 
                    <span id="basic-default-name-error" class="error">
                        {{ $message }}
                    </span>
