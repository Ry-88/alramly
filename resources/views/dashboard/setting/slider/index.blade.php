                        ...
                        <table id="table"  class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($slider->status == 'غير مفعل')
                                        <span class="badge badge-pill badge-danger">{{ $slider->status }}</span>
                                        @else 
                                        <span class="badge badge-pill badge-success">{{ $slider->status }}</span>
                                        @endif
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                @if($slider->status == 'غير مفعل')
                                                <a class="dropdown-item" href="{{ route('sliders.updateStatusEnabled',$slider->id) }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 mr-50"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                                    تغير الحالة
                                                </a>
                                                @else
                                                <a class="dropdown-item" href="{{ route('sliders.updateStatusDisabled',$slider->id) }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 mr-50"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                                    تغير الحالة
                                                </a>
                                                @endif
                                                ...
                                                {{-- <form class="" action="{{ route('sliders.delete',$slider->id) }}" method="post">
