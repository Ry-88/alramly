...
<div class="container" style="margin-top:20px">
    <h3 style="margin-bottom: 5rem;"> الرؤية </h3>
       <form class="form form-vertical" action="{{ route('setting.visions.update',$vision->id) }}" method="POST" enctype="multipart/form-data">
           @csrf
              @method('PUT')
           <div class="row">
               <div class="col-8">
                   <div class="form-group">
                       ...
                       <input type="text" id="first-name-vertical" class="form-control" name="title" value="{{ $vision->title }}">
                       @error('title') 
