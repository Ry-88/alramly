...
@section('content')
    <div class="container" style="margin-top:20px;margin-bottom:20px">
     <h3 style="margin-bottom: 5rem;"> تعديل البيانات </h3>
        <form class="form form-vertical" action="{{ route('submeuns.update',$subMenu->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-8">
                    <div class="form-group">
                        ...
                        <input type="text" id="first-name-vertical" class="form-control" name="name" value="{{ $subMenu->name }}">
                        @error('name') 
                ...
                <div class="col-8">
                    <div class="form-group">
                        ...
                        <input type="text" id="first-name-vertical" class="form-control" name="endpoint" value="{{ $subMenu->endpoint}}">
                        @error('endpoint') 
                        <span id="basic-default-name-error" class="error">
                            {{ $message }}
                        </span>
