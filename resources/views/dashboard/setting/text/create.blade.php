...
<div class="container" style="margin-top:20px">
    <h3 style="margin-bottom: 5rem;">الأماكن</h3>
       <form class="form form-vertical" action="{{ route('texts.store') }}" method="POST" enctype="multipart/form-data">
           @csrf
           <div class="row">
               <div class="col-8">
               ...
               <div class="col-8">
                <div class="form-group">
                    <label for="email-id-vertical">النص</label>
                       <textarea id="editor"  class="form-control" name="body" id="email-id-vertical" rows="3"></textarea>
                    @error('body') 
                    <span id="basic-default-name-error" class="error">
                        {{ $message }}
                    </span>
