...
<div class="container" style="margin-top:20px">
    ...
    <div class="row">
        <div class="col-6">
            <h3 style="margin-bottom: 5rem;"> عن الجمعية </h3>
        </div>
        <div class="col-6">
            <a href="{{ route('visions.index') }}" class="btn btn-outline-success waves-effect">رجوع</a>
        </div>
    </div>
       <form class="form form-vertical" action="{{ route('visions.store') }}" method="POST" enctype="multipart/form-data">
           @csrf 
           <div class="row">
               <div class="col-8">
                   <div class="form-group">
                       ...
                       <select type="text" id="first-name-vertical" class="form-control" name="title">
                         <option value="Goals">الاهداف</option>
               ...
               {{-- <div class="col-8">
                <div class="form-group">
                    <label for="first-name-vertical"> العنوان الانجليزي</label>
