...
<div class="container" style="margin-top:20px">
    ...
    <div class="row">
       ...
       <form class="form form-vertical" action="{{ route('places.update',$place->id) }}" method="POST" enctype="multipart/form-data">
           @csrf
           @method('PUT')
           <div class="row">
               <div class="col-8">
                   <div class="form-group">
                       ...
                       <input type="text" id="first-name-vertical" class="form-control" name="name" value="{{ $place->name }}">
                       @error('name') 
