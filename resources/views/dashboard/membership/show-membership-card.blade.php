...
<html lang="en">
    ...
    $parsonalImagePath = public_path('/'.$data['image']);
...
<body>
    ...
    <section>
        <div class="card">
            <div class="front">
                <img src="data:image/{{ $data['image_extension'] }};base64,{{ $parsonalImage }}" class="person" alt="">
                <h2>{{ $data['full_name']}}</h2>
                <h2 class="en">{{ $data['full_name_en']}}</h2>

               

                <h3> 
                    <div class="one"><i>رقم العضوية</i></div>
                    <div class="one"><span>{{ $data['membership_no']}} </span></div>
                     
                </h3> 

                <h3> 
                    <div class="one"><i>تاريخ الانتهاء</i></div>
                    <div class="one"><span>{{ $data['expirted_at']}} </span></div>
            ...
            <h3 class="membership-type"> 
               ...
               <div class="one"><i> <span> {{ $data['membership_type']}}</span></div>
