...
<div class="container" style="margin-top:20px">
      ...
      <div class="row">
        <div class="col-6">
            <h3 style="margin-bottom: 5rem;">أضافة مشروع  </h3>
        </div>
        <div class="col-6">
            <a href="{{ route('projects.index') }}" class="btn btn-outline-success waves-effect">رجوع</a>
        </div>
    </div>
       <form class="form form-vertical" action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
           @csrf
           <div class="row">
               <div class="col-8">
               ...
               <div class="col-8">
                <div class="form-group">
                    ...
                    <input type="text" id="first-name-vertical" class="form-control" name="target_group">
                    @error('target_group') 
                    <span id="basic-default-name-error" class="error">
                        {{ $message }}
                    </span>
            ...
            <div class="col-8">
                <div class="form-group">
                    ...
                    <input type="text" id="first-name-vertical" class="form-control" name="target_group_en">
            ...
            <div class="col-8">
                <div class="form-group">
                    ...
                    <input type="text" id="first-name-vertical" class="form-control" name="place">
                    @error('place') 
                    <span id="basic-default-name-error" class="error">
                        {{ $message }}
                    </span>
            ...
            <div class="col-8">
                <div class="form-group">
                    ...
                    <input type="text" id="first-name-vertical" class="form-control" name="place_en">
                    @error('place_en') 
                    <span id="basic-default-name-error" class="error">
                        {{ $message }}
                    </span>
              ...
              <div class="col-8">
                <div class="form-group">
                    <label for="email-id-vertical">الوصف بالانجليزي</label>
                       <textarea id="editorEn"  class="form-control" name="description_en" id="email-id-vertical" rows="3"></textarea>
