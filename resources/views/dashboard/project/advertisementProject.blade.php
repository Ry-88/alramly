                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="table"  class="table table-hover">
                            ...
                            <tbody>
                                @foreach($project->advertisements as  $advertisement)
                                <tr>
                                    <td>
                                        <span class="font-weight-bold">{{ $advertisement->facility_name }}</span>
                                    </td>
                                   
                                    <td>
                                        <span class="font-weight-bold">{{ $advertisement->coordinator }}</span>
                                    </td>

                                    <td>
                                        <span class="font-weight-bold">{{ $advertisement->phone }}</span>
                                    </td>

                                    <td>
                                        <span class="font-weight-bold">{{ $advertisement->city }}</span>
                                    </td>

                                    <td>
                                        <span class="font-weight-bold">{{ $advertisement->email }}</span>
                                    </td>
