...
<div style="padding-top: 170px;">
   <div class="container text-center">
      <h1 class="fs-2 orange text-start mb-3">{{ $article->title }}</h1>
      <div class="bg-orange px-3 pt-1 mb-4" style="border-radius: 10px;">
         <div class="row">
            <div class="col-6">
               <p class="mb-0 text-start">{{ \Carbon\Carbon::createFromTimeStamp(strtotime($article->created_at))->diffForHumans() }}</p>
            </div>
            <div class="col-6">
         ...
         <div class="owl-stage-outer">
            <div class="owl-stage" style="transform: translate3d(951px, 0px, 0px); transition: all 0.5s ease 0s; width: 2377px;">
               ...
               <div class="owl-item active" style="width: 345.333px; margin-left: 130px;">
                  <div class="item">
                     <img src="{{ asset($article->image->path) }}" alt="">
                  </div>
               </div>
            </div>
         </div>
      ...
      <img src="{{ asset('/'.$article->image->path) }}" alt="" width="500" class="img-fluid mt-4">
      <h5 class="mt-4">
          {!! $article->content !!}
      </h5>
   </div>
